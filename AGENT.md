...
Ice Hockey League Management Platform — multi-tenant SaaS for managing seasons, teams, players, games, and public league websites with AI-powered content generation (game recaps, SEO texts, home widgets), public game reporting with email verification, passwordless authentication, and localized German/English URLs.
