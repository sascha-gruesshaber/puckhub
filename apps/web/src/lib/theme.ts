...
export function generateCssVariables(colors: ThemeColors): string {
  return `:root {
  --web-primary: ${colors.primary};
  --web-secondary: ${colors.secondary};
  --web-accent: ${colors.accent};
  --web-bg: ${colors.background};
  --web-text: ${colors.text};
  --web-header-bg: ${colors.headerBg};
  --web-header-text: ${colors.headerText};
  --web-footer-bg: ${colors.footerBg};
  --web-footer-text: ${colors.footerText};
}`
}
