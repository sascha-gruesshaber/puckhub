...
export function GameCard({
  ...
  return (
    <Link
      ...
      params={{ gameId: id }}
      className={cn(
        "block rounded-lg border border-web-text/10 bg-white p-4 transition-all hover:shadow-md hover:border-web-primary/30",
        className,
      )}
    >
      {/* Round info */}
      {round && !compact && (
        <div className="text-xs text-web-text/50 mb-2">
      ...
      {/* Date/time */}
      {scheduledAt && (
        <div className="text-xs text-web-text/50 mt-2 text-center">
