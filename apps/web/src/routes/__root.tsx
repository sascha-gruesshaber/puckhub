...
import { ConfigContext, OrgContext, SeasonContext, SettingsContext, ThemeContext } from "~/lib/context"
import { generateCssVariables, resolveTheme } from "~/lib/theme"
import webCss from "~/styles/web.css?url"
        ...
        <SettingsContext.Provider value={settings}>
          <ConfigContext.Provider value={config}>
            <ThemeContext.Provider value={theme}>
              <SeasonContext.Provider value={seasonCtx}>{children}</SeasonContext.Provider>
