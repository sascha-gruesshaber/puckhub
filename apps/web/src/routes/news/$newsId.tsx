...
function NewsDetailPage() {
    ...
    return (
      <SectionWrapper>
        <div className="text-center py-12">
          ...
          <Link to="/news" className="text-web-primary hover:underline">
            Zurück zu News
          </Link>
        </div>
      </SectionWrapper>
  ...
  return (
    <div className="animate-fade-in">
      <SectionWrapper>
        <Link to="/news" className="inline-flex items-center gap-1 text-sm text-web-text/50 hover:text-web-primary mb-6">
        ...
        <article className="mx-auto max-w-3xl">
          ...
          <div className="flex items-center gap-2 text-sm text-web-text/50 mb-8">
          ...
          {article.shortText && (
            <p className="text-lg text-web-text/70 mb-6 leading-relaxed">{article.shortText}</p>
          )}
