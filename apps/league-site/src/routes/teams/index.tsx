        ...
        {isLoading ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="rounded-lg border border-league-text/10 bg-white p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {teams.map((team) => (
              <Link
                ...
                className="group block rounded-lg border border-league-text/10 bg-white p-6 text-center transition-all hover:shadow-md hover:border-league-primary/30"
              >
