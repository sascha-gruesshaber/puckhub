...
interface ReleasePlayerSheetProps {
  open: boolean
...
function ReleasePlayerSheet({ open, onOpenChange, contract, seasonId }: ReleasePlayerSheetProps) {
      ...
      <Sheet open={open} onOpenChange={onOpenChange} dirty={isDirty} onDirtyClose={() => setConfirmCloseOpen(true)}>
        <SheetContent>
          ...
          <SheetHeader>
            ...
            <SheetDescription>{t("rosterPage.releaseDialog.description", { player: playerName })}</SheetDescription>
          </SheetHeader>
