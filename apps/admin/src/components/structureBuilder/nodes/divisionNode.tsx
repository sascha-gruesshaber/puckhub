...
function DivisionNodeComponent({ data, selected }: NodeProps) {
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: drag-and-drop drop target node
    // biome-ignore lint/a11y/noStaticElementInteractions: drag-and-drop drop target node
    <div
